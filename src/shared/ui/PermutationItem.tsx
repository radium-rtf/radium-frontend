...
export const PermutationItem: FC<IProps> = ({ value, className, ...props }) => {
  ...
  return (
    <div
      ...
      {...props}
      className={cn(
        'flex items-center gap-4 rounded-lg border border-transparent px-6 py-2 -outline-offset-1 outline-white transition-colors focus-visible:bg-white/5 focus-visible:outline',
