...
import { CloseButton, cn, FileType, Icon, useDrop } from "..";
...
export const InputFile: FC<IProps> = ({
    ...
    const handleFileChange = (file: File) => {
        ...
        if (fileType === undefined || (allowedFileTypes & FileType[fileType as keyof typeof FileType]) === 0) {
            setAttachError(true)
            return;
        }
    ...
    return (<div className="w-full h-9 items-center">
        <label
            htmlFor={inputId}
            onDrop={e => {
                e.stopPropagation();
        ...
        >
            ...
            <div className="mr-0 ml-auto flex gap-4 text-text-secondary">
